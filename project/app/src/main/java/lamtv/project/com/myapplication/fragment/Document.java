...
public class Document {
    ...
    public org.w3c.dom.Document getDocument(LatLng start, LatLng end, String mode) {
    ...
    public String getDurationText(org.w3c.dom.Document doc) {
        try {
    ...
    public int getDurationValue(org.w3c.dom.Document doc) {
        try {
            NodeList nl1 = doc.getElementsByTagName("duration");
            Node node1 = nl1.item(0);
            NodeList nl2 = node1.getChildNodes();
    ...
    public int getDistanceValue(org.w3c.dom.Document doc) {
        try {
    ...
    public String getStartAddress(org.w3c.dom.Document doc) {
        try {
    ...
    public String getEndAddress(org.w3c.dom.Document doc) {
        try {
    ...
    public String getCopyRights(org.w3c.dom.Document doc) {
        try {
    ...
    public ArrayList<LatLng> getDirection(org.w3c.dom.Document doc) {
